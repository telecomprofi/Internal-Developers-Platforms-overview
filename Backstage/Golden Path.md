...
Golden Path in platform engineering is a collection of either tickets or tasks that every team has to perform when new project is started. Because this work is often repetitive we can include it into Scaffolder template in Backstage/LaunchPad and speed-up these tasks execution or completely automate them.
